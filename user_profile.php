...
$sql44="select *,users.idclinic as idcl from users where id=$_POST[vid]";
...
<form action='index.php?pg=28' method=post onsubmit='return check();'>
<table>
...
<input type=hidden name=vid value='$row44[id]' ></td></tr>
<input type=hidden name=vphone value='' ></td></tr>
<input type=hidden name=vspeciality value='' ></td></tr>
<input type=hidden name=vidclinic value='' ></td></tr>
<input type=hidden name=vhiredate value='' ></td></tr>
...
<tr><td>Speciality:</td><td><select name=vspeciality >
											...
											<option name=vspeciality value=Ορθοπαιδικός>Ορθοπαιδικός</option>
									</select></td></tr>
<tr><td>Office Phone:</td><td><input type=text name=vphone id=iphone value='$row44[officephone]'></td></tr>
<tr><td>Hire Date: </td><td><input type=date name=vhiredate value='$row44[hiredate]'>
<input type=hidden name=vid value='$row44[id]' ></td></tr>
...
<form action='index.php?pg=28' method=post '>
<table>
<tr><td>email*:</td><td><input type=text name=vemail id=iemail value='$row44[email]'></td></tr>
<tr><td>password*:</td><td><input type=password name=vpass id=ipass></td></tr>
<tr><td>Firstname:</td><td><input type=text name=vfirstname value='$row44[fname]'></td></tr>
...
<tr><td>Hire Date: </td><td><input type=date name=vhiredate value='$row44[hiredate]'>
<input type=hidden name=vspeciality value='' >
